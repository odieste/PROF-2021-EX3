...
public class CustomarDataAccessSingleton {
	
	private static final String url = "jdbc:mysql://profundizacion.grise.upm.es:3306/customers";
	private static final String username = "root";
	private static final String password = "1234";
	
	private static CustomarDataAccessSingleton instance;

	//
	// Singleton access method
	public static CustomarDataAccessSingleton getInstance() {
		
		if (instance != null)
			return instance;
		else {
			instance = new CustomarDataAccessSingleton();
			return instance;
		}
	...
	//
	// Constructor
	public CustomarDataAccessSingleton() {
