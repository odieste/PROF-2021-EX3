...
public class Customer {
	...
	Customer(int id, CustomerDataAccess dataAccess) throws CustomerException, DatabaseException {
		this.id = id;
		this.shippingAddress = dataAccess.getShippingAddress(id);
		this.invoicingAddress = dataAccess.getInvoicingAddress(id);
	}
