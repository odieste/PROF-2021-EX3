...
public class Customer {
	...
	Customer(int id, CustomerDataAccessSingleton custSing) throws CustomerException, DatabaseException {
		this.id = id;
		this.shippingAddress = custSing.getShippingAddress(id);
		this.invoicingAddress = custSing.getInvoicingAddress(id);
	}
